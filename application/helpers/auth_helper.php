...
function authorize($table, $fields, $username_field, $password_field,
                   $id_field, $username_value, $password_value,
                   $service_name, $cookie_name)
{
    ...
    if ($password_value === $user[0][$password_field]) {
...
function generate_jwt_cookie($username_value, $id_value, $service_name, $cookie_name)
{
    ...
    mt_srand(intval(substr($timestamp, -16, 12) / substr(join(array_map(function ($n) {
